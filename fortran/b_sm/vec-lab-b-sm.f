...
c      common/inputs/emu
      common/inputs/emu
      common/masses/mtau,mmu,mp,dm2,mmu2,mp2
...
c      If(y.gt.40000.d0) write(6,*) 'y =',y

c      if(Isnan(costh1)) then
c      write(6,*) 'q1 dot product issue', y
c      endif
...
c      if( Isnan(absqf)) then
c       write(6,*) 'qvec prob',absqf, t
c      endif 
